            ...
            >
                ...
                <SwiperSlide style={{ backgroundImage: "url('https://www-oceanofgames.com/wp-content/uploads/2019/07/thumb-1920-932703-1.jpg')", backgroundRepeat: "no-repeat", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className='bg-gradient-to-r from-[#445760] to-[#44566023] h-full'>
                        <div className='px-2 md:px-0 xl:container mx-auto flex flex-col-reverse md:flex-row md:items-center gap-10 sphere-secondary h-full'>
                            <div className='w-full md:w-7/12'>
                                <h4 className='text-2xl font-playfair'>Football Revolution</h4>
                                <h2 className='font-playfair text-4xl'>Unleash Your Skills, Elevate Your Game</h2>
